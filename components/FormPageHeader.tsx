...
const FormPageHeader = ({form} : {form: IFormsEntity}) => {
  return (
    <header className='flex flex-col items-start sm:items-center gap-y-4 fixed w-full
    pt-4 px-4 bg-white shadow z-50'>
        <div className='flex items-start w-full sm:items-center justify-between'>
            ...
            <div className='flex item-center sm:gap-x-4'>
                <SendForm/>
